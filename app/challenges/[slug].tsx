  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {allComplete ? (
          <View
            style={[styles.card, styles.nextSessionCard, styles.completeCard]}
          >
            <View style={styles.cardHeader}>
              <View
                style={[
            ...
            <Text style={styles.completeText}>
              Congratulations! You&apos;ve completed all sessions in this
              program.
            </Text>
          </View>
        ) : nextSession ? (
