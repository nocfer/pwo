/**
 * UndoToast — bottom "Deleted · Undo" toast with a countdown ring.
 *
 * The reversible-delete variant of Toast: the item is removed optimistically and
 * this counts down; when the ring completes the delete commits (onComplete), and
 * Undo (onUndo) restores it. One at a time. The animated sweep is the specialized
 * sibling of the presentational Ring; honors reduced-motion (no sweep — commits
 * on a timer instead).
 */
