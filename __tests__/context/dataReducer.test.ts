...
describe('dataReducer', () => {
  it('SET_ROUTINES updates routines and sets loading to false', () => {
    ...
    const result = dataReducer(initialState, { type: 'SET_ROUTINES', routines });
  ...
  it('SET_ROUTINES_LOADING updates loading state', () => {
    const result = dataReducer(initialState, { type: 'SET_ROUTINES_LOADING', loading: false });
    expect(result.routinesLoading).toBe(false);
  });

  it('SET_LAST_COMPLETED_SLUG updates slug', () => {
    const result = dataReducer(initialState, { type: 'SET_LAST_COMPLETED_SLUG', slug: 'test-slug' });
  ...
  it('SET_LAST_COMPLETED_SLUG can set to null', () => {
    ...
    const result = dataReducer(stateWithSlug, { type: 'SET_LAST_COMPLETED_SLUG', slug: null });
  ...
  it('INCREMENT_PROGRESS_VERSION increments version', () => {
    ...
    const result = dataReducer(initialState, { type: 'INCREMENT_PROGRESS_VERSION' });
  ...
  it('INCREMENT_HISTORY_VERSION increments version', () => {
    ...
    const result = dataReducer(initialState, { type: 'INCREMENT_HISTORY_VERSION' });
  ...
  it('INCREMENT_COMPLETED_VERSION increments version', () => {
    ...
    const result = dataReducer(initialState, { type: 'INCREMENT_COMPLETED_VERSION' });
  ...
  it('preserves other state properties on partial updates', () => {
    ...
    const result = dataReducer(stateWithData, { type: 'INCREMENT_HISTORY_VERSION' });
